...
import vn.lachongmedia.appnv.adapter.AdapterRecyclerQuanLyGuiBan;
 ...
 * Created by tungda .
 */
public class QuanLyGuiBanFragment extends Fragment {
    public QuanLyGuiBanFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_quanlyguiban, container, false);
     /*   MapFragment mapFragment = (MapFragment) getActivity().getFragmentManager()
                .findFragmentById(R.id.maps);
*/
        recyclerViewAlbum = rootView.findViewById(R.id.rvDanhSachMatHang);
        ...
        cuaHangs.add(new CuaHang());
        cuaHangs.add(new CuaHang());
        AdapterRecyclerQuanLyGuiBan adapterRecyclerQuanLyGuiBan=new AdapterRecyclerQuanLyGuiBan(getActivity(),cuaHangs);
        recyclerViewAlbum.setAdapter(adapterRecyclerQuanLyGuiBan);
        adapterRecyclerQuanLyGuiBan.setOnItemClickedListener(new AdapterRecyclerQuanLyGuiBan.OnItemClickedListener() {
            @Override
