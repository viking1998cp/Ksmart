...
import vn.lachongmedia.appnv.adapter.AdapterRecyclerLapKeHoachKhachhang;
 ...
 * Created by tungda .
 */
public class LapKeHoachKhachHangActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_taokehoachkhachhang);
        initUI();
        back();
        ...
        cuaHangs.add(new CuaHang());
        cuaHangs.add(new CuaHang());
        AdapterRecyclerLapKeHoachKhachhang adapterRecyclerTaoPhanHoi = new AdapterRecyclerLapKeHoachKhachhang(getApplicationContext(), cuaHangs);
        rvDanhSach.setAdapter(adapterRecyclerTaoPhanHoi);
        adapterRecyclerTaoPhanHoi.setOnItemClickedListener(new AdapterRecyclerLapKeHoachKhachhang.OnItemClickedListener() {
            @Override
