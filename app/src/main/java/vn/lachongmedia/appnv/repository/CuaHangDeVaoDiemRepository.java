 ...
 */
public class CuaHangDeVaoDiemRepository {
    private MutableLiveData<ArrayList<CuaHang>> mutableLiveData = new MutableLiveData<>();
    public MutableLiveData<ArrayList<CuaHang>> getMutableLiveData(Location location){
        try {
            ...
            service.getCuaHangDeVaoDiem(params).enqueue(new Callback<ListCuaHangRespon>() {
                @Override
