 ...
 * Created by tungda .
 */
public class AdapterRecyclerMatHangGuiBan extends RecyclerView.Adapter<AdapterRecyclerMatHangGuiBan.ItemRowHolder> {
    private ArrayList<CuaHang> listCuaHang;
    private Context context;
    private OnItemClickedListener onItemClickedListener;

    public AdapterRecyclerMatHangGuiBan(Context context, ArrayList<CuaHang> listCuaHang) {
    ...
    public ItemRowHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_danhsachmathangguiban, null);
