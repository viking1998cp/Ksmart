 ...
 * Created by tungda .
 */
public class AdapterRecyclerBaoCaoPhienLamViec extends RecyclerView.Adapter<AdapterRecyclerBaoCaoPhienLamViec.ItemRowHolder> {
    private ArrayList<CuaHang> listCuaHang;
    private Context context;
    private OnItemClickedListener onItemClickedListener;

    public AdapterRecyclerBaoCaoPhienLamViec(Context context, ArrayList<CuaHang> listCuaHang) {
    ...
    public ItemRowHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_danhsachphienlamviec, null);
