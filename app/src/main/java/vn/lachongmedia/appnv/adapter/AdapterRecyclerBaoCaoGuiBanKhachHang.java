 ...
 * Created by tungda .
 */
public class AdapterRecyclerBaoCaoGuiBanKhachHang extends RecyclerView.Adapter<AdapterRecyclerBaoCaoGuiBanKhachHang.ItemRowHolder> {
    private ArrayList<CuaHang> listCuaHang;
    private Context context;
    private OnItemClickedListener onItemClickedListener;

    public AdapterRecyclerBaoCaoGuiBanKhachHang(Context context, ArrayList<CuaHang> listCuaHang) {
    ...
    public ItemRowHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_baocaoguibankhachhang, null);
