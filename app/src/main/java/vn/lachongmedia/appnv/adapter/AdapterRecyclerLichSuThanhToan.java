 ...
 * Created by tungda .
 */
public class AdapterRecyclerLichSuThanhToan extends RecyclerView.Adapter<AdapterRecyclerLichSuThanhToan.ItemRowHolder> {
    private ArrayList<CuaHang> listCuaHang;
    private Context context;
    private OnItemClickedListener onItemClickedListener;

    public AdapterRecyclerLichSuThanhToan(Context context, ArrayList<CuaHang> listCuaHang) {
    ...
    public ItemRowHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_dotthanhtoan, null);
