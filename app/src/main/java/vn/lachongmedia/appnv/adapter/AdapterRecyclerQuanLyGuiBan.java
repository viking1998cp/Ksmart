 ...
 * Created by tungda .
 */
public class AdapterRecyclerQuanLyGuiBan extends RecyclerView.Adapter<AdapterRecyclerQuanLyGuiBan.ItemRowHolder> {
    private ArrayList<CuaHang> listCuaHang;
    private Context context;
    private OnItemClickedListener onItemClickedListener;

    public AdapterRecyclerQuanLyGuiBan(Context context, ArrayList<CuaHang> listCuaHang) {
    ...
    public ItemRowHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_quanlycongno, null);
