 ...
 * Created by tungda .
 */
public class AdapterRecyclerKeHoachKhachhang extends RecyclerView.Adapter<AdapterRecyclerKeHoachKhachhang.ItemRowHolder> {
    private ArrayList<CuaHang> listCuaHang;
    private Context context;
    private OnItemClickedListener onItemClickedListener;

    public AdapterRecyclerKeHoachKhachhang(Context context, ArrayList<CuaHang> listCuaHang) {
    ...
    public ItemRowHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_kehoachkhachhang, null);
