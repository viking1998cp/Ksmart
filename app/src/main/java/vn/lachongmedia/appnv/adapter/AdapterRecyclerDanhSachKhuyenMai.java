 ...
 * Created by tungda .
 */
public class AdapterRecyclerDanhSachKhuyenMai extends RecyclerView.Adapter<AdapterRecyclerDanhSachKhuyenMai.ItemRowHolder> {
    private ArrayList<CuaHang> listCuaHang;
    private FragmentActivity context;
    private OnItemClickedListener onItemClickedListener;

    public AdapterRecyclerDanhSachKhuyenMai(FragmentActivity context, ArrayList<CuaHang> listCuaHang) {
    ...
    public ItemRowHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_danhsachkhyenmai, null);
