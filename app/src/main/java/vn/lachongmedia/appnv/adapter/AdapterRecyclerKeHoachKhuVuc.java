 ...
 * Created by tungda .
 */
public class AdapterRecyclerKeHoachKhuVuc extends RecyclerView.Adapter<AdapterRecyclerKeHoachKhuVuc.ItemRowHolder> {
    private ArrayList<CuaHang> listCuaHang;
    private Context context;
    private OnItemClickedListener onItemClickedListener;

    public AdapterRecyclerKeHoachKhuVuc(Context context, ArrayList<CuaHang> listCuaHang) {
    ...
    public ItemRowHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_kehoachkhuvuc, null);
