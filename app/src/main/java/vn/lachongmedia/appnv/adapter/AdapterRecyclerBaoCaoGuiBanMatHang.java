 ...
 * Created by tungda .
 */
public class AdapterRecyclerBaoCaoGuiBanMatHang extends RecyclerView.Adapter<AdapterRecyclerBaoCaoGuiBanMatHang.ItemRowHolder> {
    private ArrayList<CuaHang> listCuaHang;
    private Context context;
    private OnItemClickedListener onItemClickedListener;

    public AdapterRecyclerBaoCaoGuiBanMatHang(Context context, ArrayList<CuaHang> listCuaHang) {
    ...
    public ItemRowHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_baocaoguibanmathang, null);
