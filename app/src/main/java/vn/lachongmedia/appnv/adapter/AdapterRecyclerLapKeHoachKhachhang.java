 ...
 * Created by tungda .
 */
public class AdapterRecyclerLapKeHoachKhachhang extends RecyclerView.Adapter<AdapterRecyclerLapKeHoachKhachhang.ItemRowHolder> {
    private ArrayList<CuaHang> listCuaHang;
    private Context context;
    private OnItemClickedListener onItemClickedListener;

    public AdapterRecyclerLapKeHoachKhachhang(Context context, ArrayList<CuaHang> listCuaHang) {
    ...
    public ItemRowHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_taokehoachkhachhang, null);
