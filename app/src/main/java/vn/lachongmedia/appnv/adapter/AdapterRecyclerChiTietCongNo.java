 ...
 * Created by tungda .
 */
public class AdapterRecyclerChiTietCongNo extends RecyclerView.Adapter<AdapterRecyclerChiTietCongNo.ItemRowHolder> {
    private ArrayList<CuaHang> listCuaHang;
    private Context context;
    private OnItemClickedListener onItemClickedListener;

    public AdapterRecyclerChiTietCongNo(Context context, ArrayList<CuaHang> listCuaHang) {
    ...
    public ItemRowHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_chitietcongno, null);
