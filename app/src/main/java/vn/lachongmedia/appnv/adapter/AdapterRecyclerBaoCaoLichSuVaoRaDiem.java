 ...
 * Created by tungda .
 */
public class AdapterRecyclerBaoCaoLichSuVaoRaDiem extends RecyclerView.Adapter<AdapterRecyclerBaoCaoLichSuVaoRaDiem.ItemRowHolder> {
    private ArrayList<CuaHang> listCuaHang;
    private Context context;
    private OnItemClickedListener onItemClickedListener;

    public AdapterRecyclerBaoCaoLichSuVaoRaDiem(Context context, ArrayList<CuaHang> listCuaHang) {
    ...
    public ItemRowHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_baocao_lichsu_vaoradiem, null);
