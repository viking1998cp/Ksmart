 ...
 * Created by tungda .
 */
public class AdapterRecyclerBaoCaoLichSuThanhToan extends RecyclerView.Adapter<AdapterRecyclerBaoCaoLichSuThanhToan.ItemRowHolder> {
    private ArrayList<CuaHang> listCuaHang;
    private Context context;
    private OnItemClickedListener onItemClickedListener;

    public AdapterRecyclerBaoCaoLichSuThanhToan(Context context, ArrayList<CuaHang> listCuaHang) {
    ...
    public ItemRowHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_baocaolichsuthanhtoan, null);
