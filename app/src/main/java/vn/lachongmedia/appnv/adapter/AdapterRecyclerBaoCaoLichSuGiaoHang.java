 ...
 * Created by tungda .
 */
public class AdapterRecyclerBaoCaoLichSuGiaoHang extends RecyclerView.Adapter<AdapterRecyclerBaoCaoLichSuGiaoHang.ItemRowHolder> {
    private ArrayList<CuaHang> listCuaHang;
    private Context context;
    private OnItemClickedListener onItemClickedListener;

    public AdapterRecyclerBaoCaoLichSuGiaoHang(Context context, ArrayList<CuaHang> listCuaHang) {
    ...
    public ItemRowHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_baocaolichsugiaohang, null);
