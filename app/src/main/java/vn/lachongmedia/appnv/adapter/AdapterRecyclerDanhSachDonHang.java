 ...
 * Created by tungda .
 */
public class AdapterRecyclerDanhSachDonHang extends RecyclerView.Adapter<AdapterRecyclerDanhSachDonHang.ItemRowHolder> {
    private ArrayList<CuaHang> listCuaHang;
    private FragmentActivity context;
    private OnItemClickedListener onItemClickedListener;

    public AdapterRecyclerDanhSachDonHang(FragmentActivity context, ArrayList<CuaHang> listCuaHang) {
    ...
    public ItemRowHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_danhsachdonhang, null);
