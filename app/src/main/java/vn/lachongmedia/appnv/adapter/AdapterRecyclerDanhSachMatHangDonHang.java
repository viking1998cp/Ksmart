 ...
 * Created by tungda .
 */
public class AdapterRecyclerDanhSachMatHangDonHang extends RecyclerView.Adapter<AdapterRecyclerDanhSachMatHangDonHang.ItemRowHolder> {
    private ArrayList<CuaHang> listCuaHang;
    private Context context;
    private OnItemClickedListener onItemClickedListener;

    public AdapterRecyclerDanhSachMatHangDonHang(Context context, ArrayList<CuaHang> listCuaHang) {
    ...
    public ItemRowHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_mathang, null);
